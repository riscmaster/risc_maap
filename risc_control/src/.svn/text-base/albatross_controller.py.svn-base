...
'''======================================================
    ...
    File name:  	albatross_controller.py
...
class BasicDroneController(object):
    def __init__(self):
        ...
        self.subNavdata = rospy.Subscriber('albatross/ardrone/navdata',Navdata,self.ReceiveNavdata)

        # Allow the controller to publish to the /ardrone/takeoff, land and reset topics
        self.pubLand    = rospy.Publisher('albatross/ardrone/land',Empty,queue_size = 100)
        self.pubTakeoff = rospy.Publisher('albatross/ardrone/takeoff',Empty,queue_size = 100)
        self.pubReset   = rospy.Publisher('albatross/ardrone/reset',Empty,queue_size = 100)

        # Allow the controller to publish to the /cmd_vel topic and thus control the drone
        self.pubCommand = rospy.Publisher('albatross/cmd_vel',Twist,queue_size = 100)
