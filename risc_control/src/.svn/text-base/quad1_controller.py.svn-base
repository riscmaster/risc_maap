...
class BasicDroneController(object):
    def __init__(self):
        ...
        self.subNavdata = rospy.Subscriber('/quad1/ardrone/navdata',Navdata,self.ReceiveNavdata)

        # Allow the controller to publish to the /ardrone/takeoff, land and reset topics
        self.pubLand    = rospy.Publisher('/quad1/ardrone/land',Empty)
        self.pubTakeoff = rospy.Publisher('/quad1/ardrone/takeoff',Empty)
        self.pubReset   = rospy.Publisher('/quad1/ardrone/reset',Empty)

        # Allow the controller to publish to the /cmd_vel topic and thus control the drone
        self.pubCommand = rospy.Publisher('/quad1/cmd_vel',Twist)
...
if __name__=='__main__':
    ...
    while not rospy.is_shutdown():
        joy = rospy.Subscriber('/quad1/joy', Joy, ReceiveJoystickMessage)
