...
class BasicDroneController(object):
    def __init__(self):
        ...
        self.subNavdata = rospy.Subscriber('/risc2/ardrone/navdata',Navdata,self.ReceiveNavdata)

        # Allow the controller to publish to the /ardrone/takeoff, land and reset topics
        self.pubLand    = rospy.Publisher('/risc2/ardrone/land',Empty,queue_size = 100)
        self.pubTakeoff = rospy.Publisher('/risc2/ardrone/takeoff',Empty,queue_size = 100)
        self.pubReset   = rospy.Publisher('/risc2/ardrone/reset',Empty,queue_size = 100)

        # Allow the controller to publish to the /cmd_vel topic and thus control the drone
        self.pubCommand = rospy.Publisher('/risc2/cmd_vel',Twist,queue_size = 100)
...
if __name__=='__main__':
    ...
    while not rospy.is_shutdown():
        joy = rospy.Subscriber('/risc2/joy', Joy, ReceiveJoystickMessage)
