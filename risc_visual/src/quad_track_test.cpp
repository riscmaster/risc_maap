...
static const char WINDOW5[] = "yellow green border";
	...
	int green[] = {80,40,240,25,240,30,1,1};
	int blue[] = {140,100,255,15,180,5,1,2};
	int red[] = {3,175,255,190,251,6,1,1};
...
{
cv::Vec3b color[24] = {cv::Vec3b( 0, 7, 245),cv::Vec3b( 7,71,255),cv::Vec3b( 0,128,241),cv::Vec3b( 13,191,255),cv::Vec3b( 60,254,254),cv::Vec3b( 50,253,202),cv::Vec3b( 0,255,129),cv::Vec3b( 0,241,58),cv::Vec3b( 60,254,53),cv::Vec3b( 57,255,0),cv::Vec3b( 129,254,1),cv::Vec3b( 201,254,57),cv::Vec3b( 245,246,0),cv::Vec3b( 251,186,4),cv::Vec3b( 252,136,0),cv::Vec3b( 249,65,0),cv::Vec3b( 252,1,0),cv::Vec3b( 255,1,61),cv::Vec3b( 251,0,130),cv::Vec3b( 255,3,190),cv::Vec3b( 249,0,255),cv::Vec3b( 196,0,255),cv::Vec3b( 121,0,252),cv::Vec3b( 67,8,246) };
...
if(k != 0 && k>white && k>black){ if(cvRound(C1_m/k)>23){k=1;C1_m=23;}
            if(cvRound(C1_m/k)<0){k=1;C1_m=0;}
