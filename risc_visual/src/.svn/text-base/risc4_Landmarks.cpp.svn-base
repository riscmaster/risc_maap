                                                                                            ...
                                                                                            
{
        ...
        ros::NodeHandle nh;
        pub = nh.advertise<risc_msgs::Observed_rois>("risc4/land_rois", 200);
 ...
 //       cv::namedWindow(WINDOW3, CV_WINDOW_AUTOSIZE);
        ...
        image_transport::Subscriber sub = it.subscribe("risc4/ardrone/image_raw", 1, imageCallback);
        
        im = it.advertise("risc4/ardrone/image_modi",1);
