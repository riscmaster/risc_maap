                                                                                            ...
                                                                                            
{
        ...
        ros::NodeHandle nh;
        pub = nh.advertise<risc_msgs::Observed_rois>("risc2/land_rois", 200);
 ...
 //       cv::namedWindow(WINDOW3, CV_WINDOW_AUTOSIZE);
        ...
        image_transport::Subscriber sub = it.subscribe("risc2/ardrone/image_raw", 1, imageCallback);
        
        im = it.advertise("risc2/ardrone/image_modi",1);
